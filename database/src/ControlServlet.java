...
public class ControlServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            switch (action) {
                ...
                case "/RequestQuote":
                	System.out.println("We are in the Controlservlet / requestquote");
                    requestQuote(request, response); 
                    System.out.println("RequestQuote Executed");
    ...
    private void requestQuote(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("We are in controlservlet.java request function");

        int clientID = Integer.parseInt(request.getParameter("ClientID"));
        String requestDate = request.getParameter("RequestDate");
        String status = request.getParameter("Status");
        String note = request.getParameter("Note");
        String numberOfTrees = request.getParameter("NumberOfTrees");
        String avgSize = request.getParameter("AvgSize");
        double avgHeight = Double.parseDouble(request.getParameter("AvgHeight"));
        String heightOfTallestTree = request.getParameter("HeightOfTallestTree");
        String location = request.getParameter("Location");
        double proximityToHouse = Double.parseDouble(request.getParameter("Proximity"));
        System.out.println("we are  in request quote");
        ...
        System.out.println("HeightOfTallestTree: " + heightOfTallestTree);
        System.out.println("Location: " + location);
        System.out.println("ProximityToHouse: " + proximityToHouse);

        QuoteRequest requests = new QuoteRequest(clientID, requestDate, status, note, numberOfTrees, avgSize, avgHeight, heightOfTallestTree, location, proximityToHouse);

        QuoteRequestDAO quoteRequestDAO = new QuoteRequestDAO();
        quoteRequestDAO.connect_func("john", "Pass1550");
        System.out.println("The connection function has been executed properly");
    ...
    private void clientResponse(HttpServletRequest request, HttpServletResponse response)
        ...
        String note = request.getParameter("Note");
        System.out.println("all the parameters are visible");
