...
<body>
    <div class="frame">
        ...
        <a href="QuoteResponse.jsp"><button class="custom-btn btn-7"><span>View All Quote Respond</span></button></a>
        <a href="ClientResponse.jsp"><button class="custom-btn btn-10">View All Client Response</button></a>
        <a href="ContractorResponse.jsp"><button class="custom-btn btn-11">View All Contractor Response<div class="dot"></div></button></a>
        <a href="login.jsp"><button class="custom-btn btn-14">View Bill Status</button></a>
        <br>
